...
# Constrói o caminho para a pasta 'dados' que deve estar junto ao script.
# Isso torna o script portátil e executável em qualquer máquina.
try:
...
# --- MELHORIA: Função auxiliar para processar dados de Saldo Comercial ---
...
# --- MELHORIA: Criar mapas para buscas seguras e eficientes ---
...
with st.sidebar:
    ...
    if st.button("Analisar Período", use_container_width=True, type="primary"):
        ...
        with st.spinner("Buscando e processando dados..."):
            ...
            # --- MELHORIA: Usar mapas para busca segura ---
            ...
            for fluxo in fluxos_para_buscar:
                ...
                # Filtra novamente pelo período exato de meses
...
if 'resultado' not in st.session_state:
    ...
    # Extrai os dados do session_state
    ...
    with tab_analise:
        ...
        if tipo_resultado in ['Exportação', 'Importação']:
            ...
            # Aplica filtro de Monitor de Tarifados, se ativo
            ...
            # Aplica filtro de NCMs do text_area
            if lista_ncm_filtro:
        ...
        # --- Análise de Saldo Comercial ---
            ...
            # --- MELHORIA: Utiliza a função auxiliar para processar os dataframes ---
